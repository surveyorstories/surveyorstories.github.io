...
export const formNumbers = {
  'GT Notice': [
    { value: '7', display: 'Form 7', te: 'ఫారం - 7' },
              ...
              <div>
                ...
                <div className='mb-6'>
                  ...
                  >
                    ...
                    <div className='flex items-center space-x-2'>
                      <RadioGroupItem value='mobile-number' id='mobile-number' />
                      <Label htmlFor='mobile-number'>Mobile Number wise</Label>
                    </div>
                  </RadioGroup>
                </div>
              </div>
